...
-- Question 더미 데이터
INSERT INTO question (content, hearts_count, visibility, created_at, updated_at, created_by)
VALUES ('JVM의 역할에 대해 설명해주세요.', 1, 'PUBLIC', NOW(), NOW(), 'member_1');
INSERT INTO question (content, hearts_count, visibility, created_at, updated_at, created_by)
VALUES ('의존성 주입에 대해 설명해주세요.', 2, 'PUBLIC', NOW(), NOW(), 'member_1');
INSERT INTO question (content, hearts_count, visibility, created_at, updated_at, created_by)
VALUES ('테스트 코드에 대해서 어떻게 생각하고, 작성하나요?', 0, 'PRIVATE', NOW(), NOW(), 'member_1');
