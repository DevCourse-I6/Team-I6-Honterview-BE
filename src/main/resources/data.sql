-- Member 더미 데이터
INSERT INTO member (id, email, nickname, role)
VALUES (1, 'user1@example.com', 'UserOne', 'ROLE_USER');
INSERT INTO member (id, email, nickname, role)
VALUES (2, 'user2@example.com', 'UserTwo', 'ROLE_USER');
...
INSERT INTO answer (content, question_id, member_id, created_at, updated_at)
VALUES ('JVM은 플랫폼 독립적인 코드 실행을 가능하게 합니다.', 1, 2, NOW(), NOW());

INSERT INTO answer (content, question_id, member_id, created_at, updated_at)
VALUES ('의존성 주입은 객체간의 의존성을 외부에서 주입하는 기법입니다.', 2, 1, NOW(), NOW());
INSERT INTO answer (content, question_id, member_id, created_at, updated_at)
VALUES ('의존성 주입을 통해 유연하고 확장 가능한 코드를 작성할 수 있습니다.', 2, 2, NOW(), NOW());

INSERT INTO answer (content, question_id, member_id, created_at, updated_at)
VALUES ('테스트 코드는 코드의 안정성을 보장하기 위해 중요합니다.', 3, 2, NOW(), NOW());
