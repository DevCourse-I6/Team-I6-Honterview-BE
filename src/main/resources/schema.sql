...
ALTER TABLE answer ADD COLUMN IF NOT EXISTS visibility VARCHAR(10) NOT NULL;
...
ALTER TABLE question ADD COLUMN IF NOT EXISTS visibility VARCHAR(10) NOT NULL;
